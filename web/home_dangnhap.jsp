...
<html>
    <head>
        ...
        <link rel="apple-touch-icon" href="css/apple.jsp">
        ...
        <link rel="stylesheet" href="css/home_dangnhap_css.css"/>
    ...
    <body>
            ...
            <div id="account-menu">
                <ul>
                    <li><a href="thongtincanhan">Thông tin tài khoản</a></li>
                     <li><a href="homthu">Tin Nhắn</a></li>
                    <li><a href="thaydoimk.jsp">Đổi mật khẩu</a></li>
                    <li><a href="dangnhap.jsp?action=logout">Đăng Xuất</a></li>
                </ul>
            </div>
        </div>
        ...
        <section class="banner" id="top">
            ...
            <div class="page-direction-button">
                <a href="home_dangnhap.jsp" style="border-radius: 5px 5px 0 0;"><i style="font-family: 'Open Sans', arial, sans-serif;" class="fa "> Trang chủ</i></a>
