...
<html lang="vn">
    <head>
        ...
        <!-- App css -->
        <link href="css/bootstrapadmin.css" rel="stylesheet" type="text/css">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive mt-3">
                                        ...
                                        <div class="total-amount mt-4 text-center">
                                            <h5 style="font-weight: bold; color: #333;">Tổng tiền đã thanh toán</h5>
                                            <div class="amount-display mt-2 p-3" style="font-size: 1.5em; color: #28a745; background-color: #f1f1f1; border-radius: 8px;">
                                                <c:set var="totalPaid" value="0" />
                                                <c:forEach items="${list}" var="l">
                                                    <c:if test="${l.getPaymentStatus() == 'Đã Thanh Toán'}">
                                                        <c:set var="totalPaid" value="${totalPaid + l.price}" />
                                                    </c:if>
                                                </c:forEach>
                                                ${totalPaid} VND
                                            </div>
